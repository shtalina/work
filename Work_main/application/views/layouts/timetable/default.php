...
<link href="../assets/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <main>
    ...
    <div class="container-xl">
      <a class="navbar-brand" href="https://jobcenter.tspu.edu.ru/"> <img src="https://local.tspu.edu.ru/portal/img/logoH39.png" alt="" width="50" height="35"
                 class="d-inline-block align-top "> JobCenter</a>
     ...
     <div class="collapse navbar-collapse" id="navbarsExample07XL">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/contact" tabindex="-1">Контакты</a>
          </li>
         </ul>
